...
function KeepSecret(secret) {
  this.secret = function() {var secret = secret;}
...
function Safe(safeData, rightKey) {
  this.safeData = function(){var safeData = safeData;}
  this.rightKey = function(){var rightKey = rightKey};
